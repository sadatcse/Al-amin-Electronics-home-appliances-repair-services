...
<div className="bg-gradient-to-r from-purple-50 via-blue-50 to-green-50 p-8 rounded-lg shadow-lg  ">
            ...
            <div className="text-center w-1/3 px-1 flex flex-col items-center">
                ...
                <h2 className="text-2xl text-blue-600">Service Client</h2>
            </div>
            ...
            <div className="text-center w-1/3 px-1 flex flex-col items-center">
                ...
                <h2 className="text-2xl text-green-600">Success services</h2>
            </div>
            ...
            <div className="text-center w-1/3 px-1 flex flex-col items-center">
                ...
                <h2 className="text-2xl text-yellow-600">Success Projects</h2>
            </div>
        </div>
