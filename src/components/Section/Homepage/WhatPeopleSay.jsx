...
const WhatPeopleSay = () => {
    ...
    return (
        <section className="py-6  dark:bg-neutral-800 text-gray-800">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
        <h1 className='text-center text-5xl font-bold my-5'>Customer Feedback</h1>
          ...
          <div>
            <button className='btn btn-info'>Give Your Feedback</button>
          </div>
        </div>
      </section>
    );
